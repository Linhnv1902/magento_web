...
use Linhnv\ChatSystem\Api\MessageRepositoryInterface;
use Linhnv\ChatSystem\Model\ResourceModel\ChatMessage as ResourceMessage;
use Linhnv\ChatSystem\Model\ResourceModel\ChatMessage\CollectionFactory as MessageCollectionFactory;
...
use Linhnv\ChatSystem\Model\ChatMessageFactory as MessageFactory;
...
class MessageRepository implements MessageRepositoryInterface
{
    ...
    public function save(
        ...
        $messageData = $this->extensibleDataObjectConverter->toNestedArray(
            $message,
            [],
            \Linhnv\ChatSystem\Api\Data\MessageInterface::class
        );
